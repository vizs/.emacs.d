(let ((bg "#ffffea")
  ...
  (custom-set-faces
   ...
   `(avy-lead-face                    ((t :background ,GR :foreground ,lg)))
   `(avy-lead-face-1                  ((t :background ,GR :foreground ,lg)))
   `(avy-lead-face-0                  ((t :background ,lg :foreground ,bl)))
   `(avy-lead-face-2                  ((t :background ,GR :foreground ,lg)))
